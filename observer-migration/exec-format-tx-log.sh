...
kubectl exec -it zk-source-0 -- sh -c '/tmp/format-zk-transaction-log.sh | tail -2'
kubectl exec -it zk-source-1 -- sh -c '/tmp/format-zk-transaction-log.sh | tail -2'
kubectl exec -it zk-source-2 -- sh -c '/tmp/format-zk-transaction-log.sh | tail -2'
